...
export function CalendlyModal({ isOpen, onClose, prefillData }: CalendlyModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-gradient-to-br from-slate-900 to-slate-950 rounded-2xl border border-cyan-500/20 overflow-hidden shadow-2xl shadow-cyan-500/10">
        {/* Header */}
          ...
          <div className="flex gap-3 justify-center">
            {consultationTypes.map((type) => (
              ...
              >
                ...
                <div className="text-sm text-cyan-400 font-medium mt-2">{type.price}</div>
              </button>
            ))}
          </div>
        </div>
