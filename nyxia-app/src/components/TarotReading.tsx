...
export function TarotReading({ isOpen, onClose, onReadingComplete }: TarotReadingProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      ...
      >
        {/* Header */}
        <div className="p-4 border-b border-violet-500/20 bg-gradient-to-r from-violet-900/30 to-cyan-900/30 flex items-center justify-between">
          ...
          {currentPhase === 'draw' && selectedSpread && (
            <div className="text-center space-y-8">
              ...
              <button
                onClick={performDraw}
                disabled={isDrawing}
                className="px-8 py-3 rounded-full bg-gradient-to-r from-violet-500 to-cyan-500 text-white font-medium shadow-lg shadow-violet-500/25 hover:shadow-violet-500/40 transition-all flex items-center gap-2 mx-auto"
              >
